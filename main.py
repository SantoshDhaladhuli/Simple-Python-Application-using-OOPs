...
class Point:
    ...
    def within_rectangle(self,rectangle):
        if min(rectangle.point1.x,rectangle.point2.x) < self.x < max(rectangle.point1.x,rectangle.point2.x) \
                and min(rectangle.point1.y,rectangle.point2.y) < max(rectangle.point1.y,rectangle.point2.y):
            return  True
        else:
            return False
...
point1 = Point(randint(0,500), randint(0,500))
point2 = Point(randint(50,500), randint(50,500))
...
print("The point is within the rectangle: " + str(user_point.within_rectangle(new_rectangle)))
turtle.done()